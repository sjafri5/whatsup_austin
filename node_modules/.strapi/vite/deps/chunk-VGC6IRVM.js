import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-V5XBYHTT.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-BHQZNJFE.js";
import {
  LimitsModal
} from "./chunk-VJ3TTPXY.js";
import {
...
} from "./chunk-OI2LRGII.js";
import {
  useTypedSelector
} from "./chunk-QNPCG6UW.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-NSXQSECK.js";
import {
  useConfig,
  useTracking
} from "./chunk-KKROHXX7.js";
import {
  AssetSource,
  AssetType,
...
import {
  renderAdmin
} from "./chunk-OAYXTVAR.js";
import {
  useAIAvailability
} from "./chunk-IYY7MG6I.js";
import {
  useLicenseLimits
} from "./chunk-YOJIJ37Z.js";
import {
  Table,
  useTable
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-CFWFCHPJ.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-YNW4NPF6.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-Q47K3V7T.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-P6HHG3NI.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-XPLPINLL.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZDJKIGZL.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-DAIOFK4L.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-RE6LDRB4.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-4IWXVNRT.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-EZIFME6S.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-ZKMJHVDX.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-446GE6XR.js");
          return {
...
//# sourceMappingURL=chunk-VGC6IRVM.js.map
