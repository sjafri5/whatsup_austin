...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-UR4CIAV2.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-OCYYL5FX.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-OCYYL5FX.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-OCYYL5FX.js");
...
//# sourceMappingURL=chunk-7OFK2MXE.js.map
