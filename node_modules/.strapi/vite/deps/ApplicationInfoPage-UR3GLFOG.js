...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-2UJDD2NK.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-PVUTBLC4.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-UR3GLFOG.js.map
