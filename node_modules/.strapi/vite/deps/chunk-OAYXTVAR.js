import {
  ...
  QueryClientProvider,
  img
} from "./chunk-LPV7GMI7.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-2FTCCNA7.js";
import {
  useNpsSurveySettings
} from "./chunk-RCJTBK3W.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-IYY7MG6I.js";
import {
  useGetAIUsageQuery
} from "./chunk-LWHFZBO4.js";
import {
  require_pick
} from "./chunk-XP67VNLT.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-IMKMJMCB.js";
import {
  useEnterprise
} from "./chunk-OSOECAPL.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-IGFWRARQ.js";
import {
  Login
} from "./chunk-SDPQY6XK.js";
import {
  MemoizedInputRenderer
} from "./chunk-AEA7YROY.js";
import {
  Form
} from "./chunk-GVMLHCYY.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-LVJRNSCO.js";
import {
  ConfigurationProvider
} from "./chunk-TDCXYOT2.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-337MIUMT.js";
import {
  require_baseRest
} from "./chunk-3DOMX6KO.js";
import {
  HistoryProvider
} from "./chunk-C5V5X4GT.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-H7LAXKND.js";
import {
  Layouts
} from "./chunk-LQAUP3ZO.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-4T7HMIFH.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-X4IJKIQZ.js";
import {
  getByteSize
...
} from "./chunk-SXQRDIFM.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-3KT4MR5T.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-S24A33NW.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-2BNK3Y4J.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-UGVGBSXJ.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-TBZJP4PF.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-IDZZZ5CW.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-OOCSMGES.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-ZPBL4AHO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-BGLLIQGN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-HUOL4UOC.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-OTCNHQ3L.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-4FTXZ2LI.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-MIEJC2AS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-MBP2WQ4Z.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-5JTFSLXU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-IZBDU5I5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-AICU6JQF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-Z6GLCQTI.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-XYRILT6V.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-2P3IFTPC.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-3KKNU2SA.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-QC7TNDBM.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-LWC47NC2.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-WOCC63B4.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-T2OADDM4.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-A5CUIMYI.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-CYHOS6BR.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-WI7IGJC4.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-H7GBBCOG.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-UR3GLFOG.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-KLIO4IBR.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-6FHMEOAF.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-6FHMEOAF.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-6X5CRXRX.js");
...
//# sourceMappingURL=chunk-OAYXTVAR.js.map
